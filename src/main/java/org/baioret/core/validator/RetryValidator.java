...
public class RetryValidator {
    public static boolean validateParams(Retry params) {
        ...
        return validateParams(params.isFixedRetryPolicy(), params.getDelayBase(), params.getFixDelayValue(), params.getMaxRetryCount(), params.getDelayLimit());
    }

    private static boolean validateParams(boolean fixedRetryPolicy, double delayBase, Long fixDelayValue, int maxRetryCount, Long delayLimit) {
